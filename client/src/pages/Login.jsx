  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="glass neon-border rounded-2xl p-8 w-full max-w-md">
        <h2 className="neon-text text-3xl font-bold mb-2 text-center">Welcome Back</h2>
        <p className="text-slate-500 text-sm text-center mb-8">Sign in to your FX TODO account</p>
